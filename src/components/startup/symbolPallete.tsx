...
export class SymbolPalette extends BaseComponent<TProps, TState> {
  ...
  addSvgShapes = async (reader: FileReader) => {
    var newShapes = this.state.svgShapes.slice();
    sleep(100).then((r) => {
      ...
      this.setState({ svgShapes: newShapes });
    });
  };
 ...
 * State
 */
type TState = { svgShapes: NodeModel[] };
